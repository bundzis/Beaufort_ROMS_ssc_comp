...
export   COAWST_APPLICATION=BEAUFORT_RIVERS_AK_002
...
export   MY_PROJECT_DIR=${MY_ROOT_DIR}/Beaufort_Shelf_Rivers_Alpine_002
...
#   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Projects/Inlet_test/Coupled
   export MY_HEADER_DIR=${MY_PROJECT_DIR}/Beaufort_AK_002
   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Beaufort_AK_002
