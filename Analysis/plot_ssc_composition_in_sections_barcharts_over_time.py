...
depth_int_ssc_summed_from_source_in_sections = xr.Dataset(
    data_vars=dict(
         depth_int_ssc_summed_masked_kal=(['ocean_time', 'section'], depth_int_ssc_summed_masked_kal[:,:]),
         depth_int_ssc_summed_masked_col=(['ocean_time', 'section'], depth_int_ssc_summed_masked_col[:,:]),
         depth_int_ssc_summed_masked_sag=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sag[:,:]),
         depth_int_ssc_summed_masked_fis=(['ocean_time', 'section'], depth_int_ssc_summed_masked_fis[:,:]),
         #depth_int_ssc_summed_masked_sak=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sak[:,:]),
         depth_int_ssc_summed_masked_kup=(['ocean_time', 'section'], depth_int_ssc_summed_masked_kup[:,:]),
         #depth_int_ssc_summed_masked_put=(['ocean_time', 'section'], depth_int_ssc_summed_masked_put[:,:]),
         depth_int_ssc_summed_masked_sta=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sta[:,:]),
         depth_int_ssc_summed_masked_can=(['ocean_time', 'section'], depth_int_ssc_summed_masked_can[:,:]),
         depth_int_ssc_summed_masked_kat=(['ocean_time', 'section'], depth_int_ssc_summed_masked_kat[:,:]),
         depth_int_ssc_summed_masked_hul=(['ocean_time', 'section'], depth_int_ssc_summed_masked_hul[:,:]),
         depth_int_ssc_summed_masked_jag=(['ocean_time', 'section'], depth_int_ssc_summed_masked_jag[:,:]),
         #depth_int_ssc_summed_masked_sik=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sik[:,:]),
         depth_int_ssc_summed_masked_sec1=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec1[:,:]),
         depth_int_ssc_summed_masked_sec2=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec2[:,:]),
         depth_int_ssc_summed_masked_sec3=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec3[:,:]),
         depth_int_ssc_summed_masked_sec4=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec4[:,:]),
         depth_int_ssc_summed_masked_sec5=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec5[:,:]),
         depth_int_ssc_summed_masked_sec6=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec6[:,:]),
         depth_int_ssc_summed_masked_sec7=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec7[:,:]),
         depth_int_ssc_summed_masked_sec8=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec8[:,:]),
         depth_int_ssc_summed_masked_sec9=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec9[:,:]),
         depth_int_ssc_summed_masked_sec10=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec10[:,:]),
         depth_int_ssc_summed_masked_sec11=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec11[:,:]),
         depth_int_ssc_summed_masked_sec12=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec12[:,:]),
         depth_int_ssc_summed_masked_sec13=(['ocean_time', 'section'], depth_int_ssc_summed_masked_sec13[:,:])
    ),
    coords=dict(
        ocean_time=('ocean_time', time_steps),
        section=('section', np.arange(0,13,1))
    ),
    attrs=dict(description='Time-series ROMS output of depth-integrated SSC from each source in each section, with source indicated by variable name and section indicated by second index; [0] Section 1, [1] Section 2, [2] Section 3, [3] Section 4, [4] Section 5, [5] Section 6, [6] Section 7, [7] Section 8, [8] Section 9, [9] Section 10, [10] Section 11, [11] Section 12, [12] Section 13')
)
...
#depth_int_ssc_summed_from_source_in_sections.to_netcdf('/projects/brun1463/ROMS/Beaufort_Shelf_Rivers_Alpine_002/Scripts/Analysis/SSC_comp_plots/Aggregated/depth_int_ssc_summed_from_source_in_sections_aggregated_dbsed0001.nc')
# Unaggregated 
#depth_int_ssc_summed_from_source_in_sections.to_netcdf('/projects/brun1463/ROMS/Beaufort_Shelf_Rivers_Alpine_002/Scripts/Analysis/SSC_comp_plots/Unaggregated/depth_int_ssc_summed_from_source_in_sections_unaggregated_dbsed0001.nc')
